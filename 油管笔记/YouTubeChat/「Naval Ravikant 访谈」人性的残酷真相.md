...
*[赞助商信息：Eight Sleep Pod 4 Ultra 介绍，提供折扣码]*
...
**Naval:** 不，我不是 AI 末日论者。我认为那是一种有缺陷的推理路线。但是，假设，你知道，你来自 `lesswrong.com` 那样的……Slate Star Codex 世界，那里有一条从计算机和 AI 变得更强大、更强大、更强大，然后你最终得到 AGI、ASI 的谱系……似乎 LLM 是对此的一种……某种正交的移动，你……你是否认为它们不是那条道路上的一步，它有点像一个传统的分支？
