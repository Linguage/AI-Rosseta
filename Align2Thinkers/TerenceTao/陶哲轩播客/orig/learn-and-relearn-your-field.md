...
[中文版本](../zh/learn-and-relearn-your-field.zh.md)
...
Another useful way to learn more about one's field is to take a key paper in that field, and perform a citation search on that paper (i.e. search for other papers that cite the key paper). There are many tools for citation searches nowadays; for instance, [MathSciNet](https://mathscinet.ams.org/mathscinet) offers this functionality, and even a general-purpose web search engine can often give useful "hits" that one might not have previously been aware of.

See also "[ask yourself dumb questions](https://terrytao.wordpress.com/advice-on-writing-papers/)".
